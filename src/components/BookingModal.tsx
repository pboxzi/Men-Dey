...
export default function BookingModal({ experience, onClose, onSuccess }: BookingModalProps) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-[#0a0a0a] border border-neutral-900 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl"
      ...
      >
        {success ? (
          ...
          <div className="p-10 text-center space-y-6">
            ...
            <div className="bg-neutral-900/50 border border-neutral-900 rounded-xl p-4 text-left space-y-2">
          ...
          <>
            ...
            <div className="p-6 border-b border-neutral-900 space-y-4">
              <div className="flex items-start justify-between gap-4">
                ...
                <button onClick={onClose} className="p-2 rounded-lg bg-neutral-900 text-neutral-400 hover:text-white transition-colors shrink-0">
                  <X className="h-4 w-4" />
                </button>
              </div>
                ...
                {STEPS.map((s, i) => {
                  ...
                  return (
                    <React.Fragment key={s.id}>
                      <div className={`flex items-center gap-1.5 px-2 py-1 rounded text-[8px] font-mono uppercase tracking-wider transition-all ${
                      ...
                      {i < STEPS.length - 1 && (
                        <ChevronRight className={`h-3 w-3 ${isDone ? 'text-gold-500' : 'text-neutral-700'}`} />
                      )}
                    </React.Fragment>
                  );
                })}
                      ...
                      {[
                        {
                          ...
                          border: form.communicationMethod === 'whatsapp' ? 'border-emerald-500/40 bg-emerald-500/5' : 'border-neutral-900 hover:border-neutral-800',
                        ...
                        },
                        {
                          ...
                          icon: Mail,
                          color: 'text-blue-400',
                          border: form.communicationMethod === 'email' ? 'border-blue-500/40 bg-blue-500/5' : 'border-neutral-900 hover:border-neutral-800',
                ...
                {step === 4 && (
                  <motion.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
                    ...
                    <div className="p-3 bg-neutral-900/40 rounded-lg border border-neutral-900/60 flex items-start gap-2.5 text-[10px] text-neutral-400 leading-relaxed font-mono">
                      ...
                      <span>By submitting, you agree to be contacted via {form.communicationMethod === 'whatsapp' ? 'WhatsApp' : 'email'} regarding this booking. Gillian personally funds chosen experiences.</span>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
