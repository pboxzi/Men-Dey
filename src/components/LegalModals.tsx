...
export function TermsOfServiceModal({ isOpen, onClose }: LegalModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Terms of Service" maxWidth="max-w-3xl">
      <div className="space-y-6 text-xs text-[#444] leading-relaxed text-left">
        <div className="flex items-center gap-3 border-b border-[rgba(0,0,0,0.06)] pb-4">
          <Scale className="h-5 w-5 text-[#C89B3C] shrink-0" />
          <div>
            <h4 className="text-sm font-bold text-white uppercase tracking-wider font-serif">Platform Terms of Use</h4>
            <p className="text-[10px] text-[#444] font-mono uppercase mt-0.5">Last Revised: July 15, 2026 • Version 2.4</p>
          </div>
        </div>

        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">1. Agreement to Terms</h5>
          <p>
        ...
        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">2. Co-operative Code of Conduct</h5>
          <p>
        ...
        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">3. Loyalty Rewards Program</h5>
          <p>
          ...
          <div className="p-3 bg-[#F8F6F2] border border-[rgba(0,0,0,0.06)] rounded-lg space-y-1">
            <span className="font-mono font-bold text-[11px] text-[#C89B3C] uppercase tracking-wider block">Important Disclaimer</span>
        ...
        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">4. Intellectual Property</h5>
          <p>
        ...
        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">6. Limitation of Liability</h5>
          <p>
        ...
        <div className="pt-4 border-t border-[rgba(0,0,0,0.06)] flex justify-between items-center text-[10px] font-mono text-[#444]">
          <span>CO-OP GOVERNANCE BRIDGE</span>
          <span className="text-[#C89B3C] font-bold flex items-center gap-1">
...
export function PrivacyPolicyModal({ isOpen, onClose }: LegalModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Privacy Policy" maxWidth="max-w-3xl">
      <div className="space-y-6 text-xs text-[#444] leading-relaxed text-left">
        <div className="flex items-center gap-3 border-b border-[rgba(0,0,0,0.06)] pb-4">
          <Shield className="h-5 w-5 text-[#C89B3C] shrink-0" />
          <div>
            <h4 className="text-sm font-bold text-white uppercase tracking-wider font-serif">Data Privacy Shield</h4>
            <p className="text-[10px] text-[#444] font-mono uppercase mt-0.5">Last Revised: July 15, 2026 • GDPR & POPIA Compliant</p>
          </div>
        </div>

        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">Our Privacy Philosophy</h5>
          <p>
        ...
        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">1. Data We Collect</h5>
          <p>
            To deliver an authentic, functional fan sanctuary and dashboard, we collect only the minimum necessary information:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[#444]">
            <li><strong className="text-[#444]">Account Credentials:</strong> Your name, email address, and country for registration, event ticketing, and security verification.</li>
            <li><strong className="text-[#444]">Biographical Information:</strong> Optional member profile biography, favorite film quotes, and general social contact channels if provided voluntarily by you.</li>
            <li><strong className="text-[#444]">Action History:</strong> Logs of your positive achievements, submitted proposals/requests, event registrations, and physical orders.</li>
            <li><strong className="text-[#444]">Voluntary Content:</strong> Your shared Kindness Journal logs and trivia answers to calculate loyalty rewards points.</li>
          </ul>
        </section>

        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">2. How We Use Your Data</h5>
          <p>
        ...
        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">3. Data Security & Storage</h5>
          <p>
        ...
        <section className="space-y-2">
          <h5 className="font-mono text-[10px] text-[#C89B3C] font-bold uppercase tracking-widest">4. Your Access and Rights</h5>
          <p>
