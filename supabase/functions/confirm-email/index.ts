...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f9f9f9;padding:40px 20px;">
  <tr><td align="center">
    <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;">

      <!-- Header -->
      <tr><td align="center" style="padding-bottom:40px;">
        <div style="width:60px;height:60px;border-radius:50%;background:linear-gradient(135deg,#d4af37 0%,#b8860b 100%);display:inline-block;line-height:60px;text-align:center;font-size:24px;color:#ffffff;font-weight:bold;">GA</div>
      </td></tr>

      <!-- Main card -->
      <tr><td style="background-color:#ffffff;border:1px solid #e5e5e5;border-radius:16px;padding:48px 40px;">
        ...
        <tr><td style="padding-bottom:28px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9f9f9;border:1px solid #e5e5e5;border-radius:12px;padding:24px;">
            <tr><td style="padding:24px;">
              <p style="margin:0 0 6px;font-size:11px;color:#9e815b;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">Exclusive Experiences</p>
        ...
        <tr><td style="padding-bottom:28px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9f9f9;border:1px solid #e5e5e5;border-radius:12px;padding:24px;">
            <tr><td style="padding:24px;">
              <p style="margin:0 0 6px;font-size:11px;color:#9e815b;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">Members-Only Events</p>
              <p style="margin:0;font-size:14px;line-height:1.6;color:#555555;">
        ...
        <tr><td style="padding-bottom:28px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9f9f9;border:1px solid #e5e5e5;border-radius:12px;padding:24px;">
            <tr><td style="padding:24px;">
              <p style="margin:0 0 6px;font-size:11px;color:#9e815b;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">Community Hub</p>
              <p style="margin:0;font-size:14px;line-height:1.6;color:#555555;">
        ...
        <tr><td style="padding-bottom:32px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9f9f9;border:1px solid #e5e5e5;border-radius:12px;padding:24px;">
            <tr><td style="padding:24px;">
              <p style="margin:0 0 6px;font-size:11px;color:#9e815b;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">Membership Tiers</p>
              <p style="margin:0;font-size:14px;line-height:1.6;color:#555555;">
        ...
        <!-- Divider -->
        <tr><td style="padding-bottom:32px;">
          <div style="height:1px;background:linear-gradient(90deg,transparent,#ccc,transparent);"></div>
        </td></tr>

        <!-- Quick start -->
        <tr><td style="padding-bottom:32px;">
          <p style="margin:0 0 12px;font-size:11px;color:#9e815b;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">Your First Steps</p>
          <p style="margin:0 0 8px;font-size:13px;color:#888;line-height:1.6;">
            <span style="color:#1a1a1a;font-weight:600;">1.</span>&nbsp; Explore available Experiences and request one that speaks to you
          </p>
          <p style="margin:0 0 8px;font-size:13px;color:#888;line-height:1.6;">
            <span style="color:#1a1a1a;font-weight:600;">2.</span>&nbsp; Check upcoming Events and secure your spot before they fill
          </p>
          <p style="margin:0 0 8px;font-size:13px;color:#888;line-height:1.6;">
            <span style="color:#1a1a1a;font-weight:600;">3.</span>&nbsp; Upgrade your membership to unlock the full experience
          </p>
        </td></tr>

        <!-- CTA -->
        <tr><td align="center" style="padding-bottom:24px;">
          <a href="${siteUrl}/portal" style="display:inline-block;background:linear-gradient(135deg,#d4af37 0%,#b8860b 100%);color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;padding:16px 48px;border-radius:8px;">
            Enter Your Portal
          </a>
        </td></tr>
      ...
      <tr><td align="center" style="padding-top:40px;">
        <p style="margin:0 0 8px;font-size:11px;color:#888;letter-spacing:1px;text-transform:uppercase;">
